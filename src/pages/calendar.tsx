...
const sundayActivities: SundayActivity[] = [
  ...
  {
    date: '16.10.',
    title: <>Kasvivärjäys <s>sekä jousiammuntaa</s> (jousiammunta peruttu sairaustapauksen takia)</>,
      ...
      <>
        <p>
          <span>
            ...
            avautuu 1.12.2022 klo 18.00.
            Lisätietoa löydät mm. <ExternalLink href='http://www.talvi-ilta.humalasalo.net/'>tapahtuman kotisivuilta</ExternalLink>.
          </span>
        </p>
      </>
    )
  },
  {
    ...
    description: (
      <>
        <p>
          <span>
            Sisarseuramme Unikankareen (Turun keskiaikaseura) järjestämä tapahtuma Taivalsalossa. Ilmoittautuminen tapahtumaan
            avautuu 7.11.2022 klo 20.00.
            Lisätietoa löydät mm. <ExternalLink href='https://keskiaikaseuraunikankare.fi/sydantalvenjuhla2023'>tapahtuman kotisivuilta</ExternalLink>.
          </span>
        </p>
      </>
    )
  },
  {
    ...
    description: (
      <>
        <p>
          <span>
            Euroopan kuningaskunta Drachenwaldin (johon myös Hukka ja Aarnimetsä kuuluu) järjestämä suuri juhlatapahtuma.
            Tapahtuma järjestetään Alankomaissa Kasteel de Berckt - linnan tiloissa. Myös Suomesta on lähdössä sinne paljon porukkaa.
          </span>
        </p>
        <p>
          <span>
            ...
            &nbsp;(tarkemmin tietoa tullee piakkoin).
            Tapahtumaan lähteviä suomalaisia varten on myös tehty <ExternalLink href='https://www.facebook.com/groups/dw30matkalaiset/'>
            oma ryhmänsä Facebookiin</ExternalLink>.
          </span>
        </p>
      </>
    )
